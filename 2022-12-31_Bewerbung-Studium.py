...
while b == 0:
    ...
    while i < rounds:
        i += 1
        r = randint(0, 250) #Zufallszahl zwischen 0 und 250
        x = int(randint(1, r))
...
while rounds > 0:
    ...
    if dis1 > dis2:
        ...
        points_player_1 += 1
sleep(1)
print("Endpunktestand: ", player_1, ":", points_player_1, " Punkte ;", player_2, ":", points_player_2, "Punkte")
print("Herzlichen Glückwunsch. Ihr habt das Spiel beendet")
      
retry = int(input("Möchtet ihr nochmal spielen (0 = ja, 1 = nein)? "))
if retry == 0:
